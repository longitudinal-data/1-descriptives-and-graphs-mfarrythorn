...
long_to_wide <- gather(long_to_wide, Var, Val, select=c("Age", "Length", "Utterances", "Utterances.with.Letters")) %>%
    unite(VarG, Var, Session) %>%
    spread(VarG, Val)
long_to_wide <- long_to_wide[,c(1:4,8:15,5:7,16,20:27,17:19,40,44:51,41:43,28,32:39,29:31)]
```
